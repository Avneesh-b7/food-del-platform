...
function Navbar({ user = {} }) {
  ...
  return (
    <header className="bg-white/60 backdrop-blur-sm border-b border-gray-200">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `px-3 py-1.5 rounded-md text-sm transition ${
                    isActive
                      ? "bg-red-600 text-white shadow-sm" // ACTIVE STATE
                      : "bg-white text-gray-700 hover:bg-red-100" // DEFAULT
                  }`
                }
              >
                Add Item
      ...
      {open && (
        <div className="md:hidden border-t border-gray-100 bg-white">
          <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8 flex flex-col gap-4">
            {/* User info */}
            <div className="flex items-center gap-3">
              <img
                src={avatar}
            ...
            {/* --- ADDED BUTTONS (MOBILE) --- */}
            <div className="flex flex-col gap-2">
              <button className="w-full px-3 py-2 bg-red-500 text-white rounded-md text-sm hover:bg-red-600">
                Add Item
              </button>
              <button className="w-full px-3 py-2 bg-gray-100 text-gray-700 rounded-md text-sm hover:bg-gray-200">
                List Items
              </button>
              <button className="w-full px-3 py-2 bg-gray-100 text-gray-700 rounded-md text-sm hover:bg-gray-200">
                Display Orders
            ...
            <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
              <button className="px-3 py-1 rounded-md text-sm bg-red-50 text-red-700 border border-red-100 hover:bg-red-100">
                Profile
              </button>
              <button className="px-3 py-1 rounded-md text-sm bg-white text-gray-700 border border-gray-200 hover:bg-gray-50">
                Logout
